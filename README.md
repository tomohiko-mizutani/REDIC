...
Section 5.2 presents the performance evaluation experiments of DRS using Datasets 1–3, which are generated from the Jasper Ridge, Samson, and Urban datasets, respectively.
...
You can plot the results for these datasets using `runPlotDrsExpResults.m` by setting `inData` to one of the following values: `'dataset1'`, `'dataset2'`, `'dataset3_part1'`, or `'dataset3_part2'`.
